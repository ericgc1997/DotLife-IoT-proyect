...
-- Volcando datos para la tabla pulsioximetrodb.anomalias: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `pulso` (
  `ID_Dispositivo` varchar(12) NOT NULL DEFAULT '',
  `Pulso` tinyint(3) unsigned zerofill NOT NULL,
  `Tiempo` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID_Dispositivo`,`Tiempo`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla pulsioximetrodb.pulso: ~0 rows (aproximadamente)
DELETE FROM `pulso`;
/*!40000 ALTER TABLE `pulso` DISABLE KEYS */;
/*!40000 ALTER TABLE `pulso` ENABLE KEYS */;

-- Volcando estructura para tabla pulsioximetrodb.saturacion
CREATE TABLE IF NOT EXISTS `saturacion` (
  `ID_Dispositivo` varchar(12) NOT NULL DEFAULT '',
...
-- Volcando datos para la tabla pulsioximetrodb.saturacion: ~0 rows (aproximadamente)
DELETE FROM `saturacion`;
/*!40000 ALTER TABLE `saturacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `saturacion` ENABLE KEYS */;
